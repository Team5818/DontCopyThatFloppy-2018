...
public class ScaleToCube2R extends SideDependentTrajectoryExecutor {
    ...
    private static Vector2d target = new Vector2d(MathUtil.feet2inches(20),MathUtil.feet2inches(7.2));
    ...
    public ScaleToCube2R() {
        ...
        leftExecutor = new TrajectoryExecutor(LEFT_PATH, false, -180, DriveGear.GEAR_HIGH);
    }
