...
public class ScaleAutoLeft extends CommandGroup {
    ...
    public ScaleAutoLeft() {
        ...
        this.addSequential(new TimedCommand(.25));
        this.addSequential(new LeftSideOnlyTurnToCrossL());//both
        this.addSequential(new ShiftGear(DriveGear.GEAR_HIGH));
        this.addSequential(new TimedCommand(.25));
        this.addSequential(new LeftSideOnlyDriveAcrossFieldL());//left
        this.addSequential(new ShiftGear(DriveGear.GEAR_LOW));
        this.addSequential(new TimedCommand(.25));
        this.addSequential(new LeftSideOnlySpinToScaleL());
        this.addSequential(new LeftSideOnlyDriveToScaleL());//both
