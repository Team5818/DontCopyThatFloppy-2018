...
public class DriveToScaleRight extends SideDependentTrajectoryExecutor {
    ...
    public static final Waypoint[] RIGHT_PATH =
            new Waypoint[] { 
                    ...
                    new Waypoint(MathUtil.feet2inches(25) - X_OFFSET, MathUtil.feet2inches(9) - Y_OFFSET, 0) };

    public static final Waypoint[] LEFT_PATH =
            new Waypoint[] { 
                    new Waypoint(0, 0, 0), 
                    new Waypoint(MathUtil.feet2inches(15.5) - X_OFFSET, 0, 0),
                    new Waypoint(MathUtil.feet2inches(16.5) - X_OFFSET, MathUtil.feet2inches(6.0) - Y_OFFSET,
                            Pathfinder.d2r(90)),
                    new Waypoint(MathUtil.feet2inches(18.0) - X_OFFSET, MathUtil.feet2inches(23.5) - Y_OFFSET,
                            Pathfinder.d2r(90)) };
