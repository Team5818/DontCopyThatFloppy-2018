...
public class Arm extends Subsystem {
    ...
    public Arm() {
        ...
        masterTalon.configSelectedFeedbackSensor(FeedbackDevice.Analog, MOTION_MAGIC_IDX, TIMEOUT);
        masterTalon.setSensorPhase(false);
        masterTalon.configSetParameter(ParamEnum.eFeedbackNotContinuous, 1, 0x00, 0x00, 0x00);
        ...
        masterTalon.config_kF(SLOT_IDX, 1023 / MAX_VELOCITY, TIMEOUT);
        masterTalon.config_kP(SLOT_IDX, 0.006 * 1023, TIMEOUT);
        masterTalon.config_kI(SLOT_IDX, 0.0, TIMEOUT);
        masterTalon.config_kD(SLOT_IDX, 0.04 * 1023, TIMEOUT);
    ...
    public double getRawPosition() {
        return masterTalon.getSensorCollection().getAnalogIn();
    }
